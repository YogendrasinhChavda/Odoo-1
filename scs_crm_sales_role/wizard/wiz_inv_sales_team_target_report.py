...
class WizSalesTeamTargetReport(models.TransientModel):
    ...
    def export_sales_team_target_report(self):
        ...
        acc_inv_l_ids = acc_inv_l_obj.search([
            ...
            ('x_studio_invoice_date', '>=', self.date_from),
            ('x_studio_invoice_date', '<=', self.date_to),
            ('company_id', '=', company),
        ...
        for country_id in country_obj.search([
            ...
            sale_country_ids = acc_inv_l_obj.search([
                '|', ('invoice_id.type', '=', 'out_invoice'),
                ('invoice_id.type', '=', 'out_refund'),
                ('x_studio_invoice_date', '>=', self.date_from),
                ('x_studio_invoice_date', '<=', self.date_to),
            ...
            for state_id in state_ids:
                ...
                for month_st_dt in dates:
                    ...
                    sale_team_country_wise_ids = acc_inv_l_obj.search([
                        '|', ('invoice_id.type', '=', 'out_invoice'),
                        ('invoice_id.type', '=', 'out_refund'),
                    ...
                    team_sales_total = \
                        sum(sale_team_country_wise_ids.
                            mapped('x_studio_signed_amount'))
                    ...
                    pre_sale_team_country_ids = acc_inv_l_obj.search([
                        '|', ('invoice_id.type', '=', 'out_invoice'),
                        ('invoice_id.type', '=', 'out_refund'),
